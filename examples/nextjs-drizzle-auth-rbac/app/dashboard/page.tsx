    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-muted">
          Welcome back, Sarah. Here&apos;s what&apos;s happening at Acme.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="space-y-3">
          {[
            {
              text: 'New order from DataFlow Labs — Enterprise plan',
              time: '2 hours ago',
              icon: '🛒',
            },
            { text: 'GreenLeaf Co upgraded from Free to Starter', time: '5 hours ago', icon: '⬆️' },
            {
              text: 'Custom Integration quote sent to CloudNine SaaS',
              time: '1 day ago',
              icon: '📧',
            },
            ...
            <div
              key={i}
              className="flex items-center gap-3 rounded-md border border-card-border bg-card p-3"
            >
