...
import { NodeExecutionStatus, FlowRunStatus } from '@invect/core';
import type {
  BatchProvider,
  FlowAccessPermission,
  InvectDefinition as InvectDefinitionRuntime,
  TriggerType,
} from '@invect/core';
import type {
  CredentialAuthType,
  CredentialConfig,
  CredentialType,
} from '@invect/core/drizzle/sqlite';
import { randomUUID } from 'crypto';

type JSONValue = Record<string, unknown>;

type BatchStatus = 'SUBMITTED' | 'PROCESSING' | 'COMPLETED' | 'FAILED' | 'CANCELLED';
