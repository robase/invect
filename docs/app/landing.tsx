        ...
        <nav>
          <div className="container">
            ...
            <ul className="nav-links">
              ...
              <li><a href="https://github.com/robase/flow-backend" className="btn-nav">GitHub →</a></li>
            </ul>
          </div>
        </nav>
          ...
          <div className="container">
            ...
            <div className="hero-text">
              ...
              <div className="hero-actions">
                ...
                <a href="https://github.com/robase/flow-backend" className="btn-secondary">View on GitHub</a>
              </div>
              <div
          ...
          <div className="container">
            <div className="cta-box">
              ...
              <div className="cta-buttons">
                ...
                <a href="https://github.com/robase/flow-backend" className="btn-secondary">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
