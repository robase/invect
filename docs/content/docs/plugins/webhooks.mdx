...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab value="pnpm">``` pnpm add @invect/webhooks ```</Tab>
  <Tab value="npm">``` npm install @invect/webhooks ```</Tab>
  <Tab value="yarn">``` yarn add @invect/webhooks ```</Tab>
  <Tab value="bun">``` bun add @invect/webhooks ```</Tab>
</Tabs>
