...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab value="pnpm">``` pnpm add @invect/user-auth ```</Tab>
  <Tab value="npm">``` npm install @invect/user-auth ```</Tab>
  <Tab value="yarn">``` yarn add @invect/user-auth ```</Tab>
  <Tab value="bun">``` bun add @invect/user-auth ```</Tab>
</Tabs>
