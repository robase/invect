...
<Callout type="info">
  The RBAC plugin requires `@invect/user-auth` to be configured first. It handles the *authorization* layer on top of the authentication that the User Auth plugin provides.
</Callout>
