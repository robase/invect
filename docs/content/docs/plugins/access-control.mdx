...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab value="pnpm">``` pnpm add @invect/rbac ```</Tab>
  <Tab value="npm">``` npm install @invect/rbac ```</Tab>
  <Tab value="yarn">``` yarn add @invect/rbac ```</Tab>
  <Tab value="bun">``` bun add @invect/rbac ```</Tab>
</Tabs>
