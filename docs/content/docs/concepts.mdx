...
<Cards>
  <Card title="Triggers" href="/docs/triggers" description="Start flows manually, on a schedule, or from webhooks." />
  <Card title="Actions" href="/docs/actions" description="Browse built-in actions and create custom ones." />
