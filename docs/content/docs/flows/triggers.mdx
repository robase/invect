...
<Callout type="info">
  Cron scheduling is enabled by default. Disable it globally by setting `triggers.cronEnabled: false` in your [config](/docs/reference/configuration).
</Callout>
...
See [Webhooks Plugin](/docs/plugins/webhooks) for setup details.
