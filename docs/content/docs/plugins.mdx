...
<Cards>
  <Card
    title="User Auth"
    href="/docs/plugins/user-auth"
    description="Add authentication flows, session handling, and protected Invect access."
  />
  <Card
    title="RBAC"
    href="/docs/plugins/rbac"
    description="Control who can view, edit, run, and share flows."
  />
  <Card
    title="Webhooks"
    href="/docs/plugins/webhooks"
    description="Trigger flows from inbound HTTP events and external systems."
  />
</Cards>
...
<Cards>
  <Card
    ...
    description="Learn the plugin interface, schema model, hooks, and registration flow."
  />
</Cards>
