...
INVECT_ENCRYPTION_KEY="<run: npx invect secret>"
...
The schema files in `src/database/` are generated by the CLI and should not be edited manually. When you add plugins or upgrade Invect, regenerate them with `npx invect generate`.
