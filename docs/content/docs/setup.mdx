...
<Cards>
  <Card title="Core Concepts" href="/docs/concepts" description="Understand flows, nodes, and execution." />
  <Card title="CLI Reference" href="/docs/cli" description="All CLI commands and options." />
  <Card title="Plugins" href="/docs/plugins" description="Extend Invect with custom tables and actions." />
